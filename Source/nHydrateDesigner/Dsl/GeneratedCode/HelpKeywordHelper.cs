...
namespace nHydrate2.Dsl
{
	...
	/// </remarks>
	public partial class nHydrate2HelpKeywordHelper : nHydrate2HelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new nHydrate2HelpKeywordHelper.
		/// </summary>
		protected nHydrate2HelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the nHydrate2HelpKeywordHelper.
		/// </summary>
		public static nHydrate2HelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class nHydrate2HelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new nHydrate2HelpKeywordHelperBase.
		/// </summary>
		protected nHydrate2HelpKeywordHelperBase()
			: base() { }
