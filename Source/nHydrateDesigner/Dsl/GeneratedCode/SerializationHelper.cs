...
namespace nHydrate2.Dsl
{
	...
	partial class nHydrate2DomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			...
			nHydrate2SerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
	
	
	/// <summary>
	/// Helper class for serializing and deserializing nHydrate2 models.
	/// </summary>
	public abstract partial class nHydrate2SerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected nHydrate2SerializationHelperBase() { }
		#endregion
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			DslModeling::IMonikerResolver monikerResolver = store.FindMonikerResolver(nHydrate2DomainModel.DomainModelId);
			if (monikerResolver == null)
			{
				monikerResolver = new nHydrate2SerializationBehaviorMonikerResolver(store, directory);
				store.AddMonikerResolver(nHydrate2DomainModel.DomainModelId, monikerResolver);
			}
			
			// Add serialization behaviors
			directory.AddBehavior(nHydrate2SerializationBehavior.Instance);
		}
	...
	/// Helper class for serializing and deserializing nHydrate2 models.
	/// </summary>
	public sealed partial class nHydrate2SerializationHelper : nHydrate2SerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private nHydrate2SerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static nHydrate2SerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static nHydrate2SerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (nHydrate2SerializationHelper.instance == null)
					nHydrate2SerializationHelper.instance = new nHydrate2SerializationHelper();
				return nHydrate2SerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace nHydrate2.Dsl
{
	...
	partial class nHydrate2SerializationHelperBase
	{
		...
		public virtual nHydrateModel LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			...
			{
				throw new global::System.InvalidOperationException(nHydrate2DomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
					...
					{		
						...
						using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true, transactionContext))
						{
							...
							if (fileStream.Length > 5)
							{
								try
								{
									global::System.Xml.XmlReaderSettings settings = nHydrate2SerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
		...
		public virtual void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement rootElement, global::System.Xml.XmlWriter writer)
		{
			...
			if (!(rootElement is DslDiagrams::Diagram))
			{
				...
				//rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/nHydrate2";
			}
			rootElementSettings.Version = new global::System.Version("99.99.0.1");
		...
		protected virtual void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			global::System.Version expectedVersion = new global::System.Version("99.99.0.1");
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					//{
					//	nHydrate2SerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					//}
				}
				catch (global::System.ArgumentException)
				{
					nHydrate2SerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		protected virtual global::System.Xml.XmlReader TryCreateValidatingReader(DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (success && schemaSet.Count > 0)
			{
				...
				nHydrate2SerializationBehaviorSchemaValidationCallback validationCallback = new nHydrate2SerializationBehaviorSchemaValidationCallback(serializationContext);
		...
		protected static bool ResolveSchema(string targetNamespace, global::System.Xml.Schema.XmlSchemaSet schemaSet, DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (schemas != null && schemas.Count > 0)
			{
				if (schemas.Count > 1)
				{
					nHydrate2SerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
				}
				schemaSet.Add(targetNamespace, schemas[0]);
				return true;
			}
	
			nHydrate2SerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
			return false;
		}
		...
		/// </summary>
		private sealed class nHydrate2SerializationBehaviorSchemaValidationCallback
		{
			...
			internal nHydrate2SerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					nHydrate2SerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
		...
		public virtual string GetSerializedModelString(global::nHydrate2.Dsl.nHydrateModel modelRoot, global::System.Text.Encoding encoding)
		{
...
namespace nHydrate2.Dsl
{
	...
	public abstract partial class nHydrateModelBase
	{
		...
		protected virtual void ValidateMonikerAmbiguity(DslValidation::ValidationContext context)
		{
			...
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = nHydrate2SerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									nHydrate2DomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
