...
namespace nHydrate2.Dsl
{
	...
	/// </remarks>
	public partial class nHydrate2ToolboxHelper : nHydrate2ToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new nHydrate2ToolboxHelper.
		/// </summary>
		public nHydrate2ToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class nHydrate2ToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify nHydrate2 toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "nHydrate2.99.99";
		/// <summary>
		/// Toolbox item filter string used to identify Association connector tool.
		/// </summary>
		public const string AssociationFilterString = "Association.99.99";
		/// <summary>
		/// Toolbox item filter string used to identify Inheritance connector tool.
		/// </summary>
		public const string InheritanceFilterString = "Inheritance.99.99";
		/// <summary>
		/// Toolbox item filter string used to identify ViewLink connector tool.
		/// </summary>
		public const string ViewLinkFilterString = "ViewLink.99.99";
		...
		/// <summary>
		/// Constructs a new nHydrate2ToolboxHelperBase.
		/// </summary>
		protected nHydrate2ToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "nHydrate2.DslPackage.EntityToolboxItem":
					// Add Entity shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"nHydrate2.DslPackage.EntityToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "nHydrate2.DslPackage.AssociationToolboxItem":

					// Add Association connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"nHydrate2.DslPackage.AssociationToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "nHydrate2.DslPackage.InheritanceToolboxItem":

					// Add Inheritance connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"nHydrate2.DslPackage.InheritanceToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "nHydrate2.DslPackage.ViewToolboxItem":
					// Add View shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"nHydrate2.DslPackage.ViewToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "nHydrate2.DslPackage.FunctionToolboxItem":
					// Add Function shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"nHydrate2.DslPackage.FunctionToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "nHydrate2.DslPackage.StoredProcedureToolboxItem":
					// Add StoredProcedure shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"nHydrate2.DslPackage.StoredProcedureToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "nHydrate2.DslPackage.ViewLinkToolboxItem":

					// Add ViewLink connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"nHydrate2.DslPackage.ViewLinkToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::nHydrate2.Dsl.nHydrate2DomainModel));
