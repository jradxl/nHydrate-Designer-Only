...
namespace nHydrate2.DslPackage
{
	...
	/// </summary>
	internal partial class nHydrate2CommandSet : nHydrate2CommandSetBase
	{
		/// <summary>
		/// Constructs a new nHydrate2CommandSet.
		/// </summary>
		public nHydrate2CommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class nHydrate2CommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new nHydrate2CommandSetBase.
		/// </summary>
		protected nHydrate2CommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewnHydrate2ExplorerCommand,
				typeof(nHydrate2EditorFactory).GUID);
		...
		{
			nHydrate2ExplorerToolWindow explorer = this.nHydrate2ExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected nHydrate2DocData CurrentnHydrate2DocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as nHydrate2DocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected nHydrate2DocView CurrentnHydrate2DocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as nHydrate2DocView;
			}
		}
		...
		/// </summary>
		protected nHydrate2ExplorerToolWindow nHydrate2ExplorerToolWindow
		{
			get
			{
				nHydrate2ExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(nHydrate2ExplorerToolWindow), true) as nHydrate2ExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				nHydrate2ExplorerToolWindow explorerWindow = this.nHydrate2ExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class nHydrate2ClipboardCommandSet : nHydrate2ClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new nHydrate2ClipboardCommandSet.
		/// </summary>
		public nHydrate2ClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class nHydrate2ClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new nHydrate2ClipboardCommandSetBase.
		/// </summary>
		protected nHydrate2ClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
