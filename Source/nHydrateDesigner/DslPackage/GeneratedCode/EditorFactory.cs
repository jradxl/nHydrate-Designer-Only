...
namespace nHydrate2.DslPackage
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.nHydrate2EditorFactoryId)]
	internal partial class nHydrate2EditorFactory : nHydrate2EditorFactoryBase
	{
		/// <summary>
		/// Constructs a new nHydrate2EditorFactory.
		/// </summary>
		public nHydrate2EditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class nHydrate2EditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected nHydrate2EditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new nHydrate2DocView(docData, this.ServiceProvider);
		}
	}
}
